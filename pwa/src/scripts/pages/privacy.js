          ...
          <article class="info-card">
            ...
            <div class="info-card__text">
              ...
              <div>
                ...
                <p>Оператор может обрабатывать следующие данные пользователей: адрес электронной почты; данные профиля пользователя; пользовательские данные: история просмотров, оценки, комментарии, папки, подписки и сохранённые подборки; данные из браузерного расширения: название медиаконтента, сезон и серия, прогресс просмотра, ссылка на страницу просмотра; технические данные привязки расширения: код привязки, идентификатор пользователя, токен доступа, дата привязки, адрес профиля и служебное состояние синхронизации просмотров.</p>
                <p>Браузерное расширение используется только для определения просматриваемого медиаконтента на поддерживаемых видеосервисах, передачи этих данных в аккаунт пользователя и хранения в браузере локальных технических данных, необходимых для авторизации расширения и корректной синхронизации просмотров.</p>
              </div>
              ...
              <div>
                ...
                <p>Данные привязки браузерного расширения и служебные данные синхронизации могут храниться локально в защищённом хранилище браузера пользователя (`chrome.storage.local`) на его устройстве.</p>
                ...
                <p>Передача данных между браузерным расширением, веб-приложением и серверной частью сервиса осуществляется по защищённому соединению HTTPS. Оператор принимает необходимые организационные и технические меры для защиты персональных данных от неправомерного доступа, изменения, распространения или уничтожения.</p>
              </div>
      ...
      <div class="history-page info-page info-page--privacy">
        ...
        <div class="history-page__shell">
          ${hasSession ? renderAppHeader({
            ...
            supportTabs: createSupportTabs("privacy"),
          }) : ""}
